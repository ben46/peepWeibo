...
var apiprefix = 'https://api.weibo.com/',
// appkey = '2849184197',
// appsecret = '7338acf99a00412983f255767c7643d0';
appkey = '889186919',
appsecret = 'f2cdd5163ad90065331458c8c44a060a';
var userId = "15880525883",
passwd = "wb*33043565";
var redirect_uri = 'http://weibo.com/zhouzhuoqian';

var baseurl = "https://api.weibo.com/2/";

var weibo = module.exports = function() {
    this._accesstoken = "2.00fEivnB0VIwKyd80a7ee6cb0Vk1av";
...
weibo.prototype = {
    ...
    getAuthorize: function(callback) {
        ...
        params['redirect_uri'] = redirect_uri; // oauth2 回调地址
        ...
        this._request(m, url, post_headers, post_data, null,
            function(error, body, response) {
                if (error) {
                    ...
                    // console.log( 'response.body -----'   + response.headers.location  );
                    // console.log( 'response -----'  + response );
                    // code = response.headers.location.substr(6);
                    // console.log("code:" + code);
                    tt.getAccesstoken(200,
                    function(err, access_token, refresh_token) {
                        console.log(access_token);
                        tt._accesstoken = '2.00fEivnB0VIwKyd80a7ee6cb0Vk1av';
